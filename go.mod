module github.com/HM4704/ProximaSpammer

go 1.23.5

require github.com/lunfardo314/proxima v0.4.4-testnet
...
require (
	...
	github.com/lunfardo314/easyfl v0.0.0-20241220192652-d6fac839a94a // indirect
